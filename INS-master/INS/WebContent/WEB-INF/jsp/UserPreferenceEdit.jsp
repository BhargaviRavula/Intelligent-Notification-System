...
<head>
  <%
  	List<UserPreferenceGroup> uesrPreflist = (List<UserPreferenceGroup>)request.getAttribute("userPreferences");
...
<form action="SaveInitialSettings" method="post">
	<div id="selectPreferences">
		...
		{ %>
		<input type="checkbox" name="EventTypeCheckBox" value="<%=grp.getUserpref().getCategoryID()%>">
