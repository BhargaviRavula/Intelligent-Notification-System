...
{	
window.location= "/Notification_System/Dashboard"; 
}	
...
<div id="MainDisplayArea" style="float:left; width:70%; padding-top:25px; padding-left:30px;">
	<font size="6" face="BankGothic"><b>REGISTERED EVENTS</b></font>
      ...
      if(eventList!=null && eventList.size()!=0 ){
        ...
        <%}else{%>
        	<table >
       					 <tr>
       					 <td>
       					 <b><i><font size="3">There are no registered events for today under this category!!!</font></i></b>
       					 </td>
       					 </tr>
       					 <tr>
       					 <td>
       					 <b><i><font size="3">Or you have not registered for events!!! </font></i></b>
       					 </td>
       					 </tr>
       					 </table>
      <%  }%>
