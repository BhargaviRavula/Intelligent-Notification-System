...
{	
window.location= "/Notification_System/BlankPreference"; 
}	
...
<div id="MainDisplayArea" style="float:left; width:70%; padding-top:25px; padding-left:30px;">
	<font size="6" face="BankGothic"><b>EVENTS</b></font>
	<hr style="border-top: dotted 1px;" />
	 <H2><font face="Architect"><%=request.getAttribute("category") %></font></H2>
      ...
      <%
        ...
        <table >
       					 <tr>
       					 <td>
       					 <b><i><font size="3">There are no events under this category!!!</font></i></b>
       					 </td>
       					 </tr>
       					 </table>
	...
	<a href="javascript:cancelAction();"><input type="button" value="Back" name="cancel"></a>
</div>
</div>
</body>
